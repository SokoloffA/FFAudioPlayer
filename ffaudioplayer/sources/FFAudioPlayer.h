...
enum FFPlayerLogLevel {
    ...
    FFPlayer_LogPanic   = 0,  /// Something went really wrong and we will crash now. More...
    FFPlayer_LogFatal   = 8,  /// Something went wrong and recovery is not possible. More...
    FFPlayer_LogError   = 16, /// Something went wrong and cannot losslessly be recovered. More...
    FFPlayer_LogWarning = 24, /// Something somehow does not look correct. More...
    FFPlayer_LogInfo    = 32, /// Standard information. More...
    FFPlayer_LogVrbose  = 40, /// Detailed information. More...
    FFPlayer_LogDebug   = 48, /// Stuff which is only useful for libav* developers. More...
